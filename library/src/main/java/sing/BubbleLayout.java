...
public class BubbleLayout extends FrameLayout {
    ...
    public BubbleLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mArrowWidth = a.getDimension(R.styleable.BubbleLayout_arrowWidth, convertDpToPixel(8, context));
        mArrowHeight = a.getDimension(R.styleable.BubbleLayout_arrowHeight, convertDpToPixel(8, context));
        mCornersRadius = a.getDimension(R.styleable.BubbleLayout_cornersRadius, 0);
        mArrowPosition = a.getDimension(R.styleable.BubbleLayout_arrowPosition, convertDpToPixel(12, context));
        mBubbleColor = a.getColor(R.styleable.BubbleLayout_bubbleColor, Color.WHITE);

        mStrokeWidth = a.getDimension(R.styleable.BubbleLayout_strokeWidth, DEFAULT_STROKE_WIDTH);
        mStrokeColor = a.getColor(R.styleable.BubbleLayout_strokeColor, Color.GRAY);

        int location = a.getInt(R.styleable.BubbleLayout_arrowDirection, ArrowDirection.LEFT.getValue());
